function alterarPerguntaMulti() {
    ...
    xhr.open("PUT", "http://localhost:3000/perguntas_multi/" + encodeURIComponent(id), true);
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
            if (xhr.status === 200 || xhr.status === 204) {
                ...
                document.getElementById("formAlterarMulti").reset();
            } else {
